...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog - counts the number of correct NOT dog classifications
        else:
    ...
    # Calculates the number of not-a-dog images using total images & dog images counts
    ...
    # Calculates the % of correctly classified not-a-dog images
    ...
    # Return the updated results_stats_dic dictionary
